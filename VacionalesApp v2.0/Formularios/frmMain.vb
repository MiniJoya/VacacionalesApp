Public Class frmMain
    ...
    Private Sub btnActivar_Click(sender As Object, e As EventArgs) Handles btnActivar.Click
        PanelLateral.Height = btnActivar.Height
        PanelLateral.Top = btnActivar.Top
        FrmActivarVacacional1.BringToFront()
    End Sub
    ...
    Private Sub btnModifActivacion_Click(sender As Object, e As EventArgs) Handles btnModifActivacion.Click
        PanelLateral.Height = btnModifActivacion.Height
        PanelLateral.Top = btnModifActivacion.Top
        FrmModificarActivacion1.BringToFront()
    End Sub
End Class